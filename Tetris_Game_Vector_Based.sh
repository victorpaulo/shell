...
#   Version: 7.1.3 11/01/2011 BeiJing China [Updated 11/16/2013]        #
#                                                                       # 
#   Algorithm:                                                          #
#                                                                       #
#   [][] [][]   [][]            [][]   [][]          [][]   [][] [][]   #
...
show.notify()
{
   ...
   printf "\e[$((toph+20));${dist}HYongYe <complex.invoke@gmail.com>\e[$((toph+21));${dist}H11/01/2011 BeiJing China [Updated 11/16/2013]\n"
}
   ...
   -v|--version) echo "Tetris Game  Version 7.1.3 [Updated 11/16/2013]" ;;
